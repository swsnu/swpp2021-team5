...
import PastNutritionInfo from './PastNutritionInfo';
...
describe('MealList', () => {
  ...
  it('should render correctly', () => {
    const component = mount(pastNutritionInfo);
...
const recordInitialState__ = {};
const stubMenuInitialState__ = {
  selectedMenu: {
    name: 'Oatmeal',
    calories: 404,
    carbs: 60,
...
const recipeInitialState__ = {};
const mockStore__ = getMockStore(userInitialState__, recordInitialState__, stubMenuInitialState__, recipeInitialState__);
...
const recipeInitialState_ = {};
const mockStore_ = getMockStore(userInitialState_, recordInitialState_, stubMenuInitialState_, recipeInitialState_);
